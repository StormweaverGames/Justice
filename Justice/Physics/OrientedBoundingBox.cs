...
{
    /// <summary>
    /// Borrowed from https://channel9.msdn.com/Forums/Sandbox/251718-XNA-Oriented-Bounding-Box-Intersection-Test
    /// </summary>
    public class OrientedBoundingBox
    {
        ...
        {
            return Intersects(new OrientedBoundingBox(other.Min, other.Max));
        }

        public bool Intersects(BoundingSphere other)
        {
            other.Center = Vector3.Transform(other.Center, Matrix.Invert(_transforms));

            return other.Intersects(new BoundingBox(_min, _max));
        }
        ...
        public bool Intersects(OrientedBoundingBox other)
        {
            ...
            Vector3 centerOther = PhysicsUtility.Multiply(other.Center, toMe);
            Vector3 extentsOther = other.Extents;
            Vector3 separation = centerOther - _center;

            Matrix3 rotations = new Matrix3(toMe);
            Matrix3 absRotations = PhysicsUtility.Abs(rotations);
